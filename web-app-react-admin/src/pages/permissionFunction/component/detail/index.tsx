...
export default function PermissionDetail(props: IProps) {
    ...
    function renderHeader() {
        return <div className="pb-5 d-flex justify-content-between align-items-center">
            ...
            <div>
                {checkPermission(functionId.permission, commandId.update) && <button disabled={isEdit} onClick={() => saveData()} type="button" className="mr-3 btn btn-primary">Lưu</button>}
                <button onClick={() => handleClose()} type="button" className="mr-3 btn btn-light">Đóng</button>
            </div>
        </div>
    }
