    ...
    function renderHeader() {
        return <div className="pb-3 d-flex justify-content-between align-items-center">
            ...
            <div>
                ...
                <button onClick={() => setStateInit(null, !state.isEdit)} type="button" className="mx-3 hms-btn-button btn btn-primary">Chỉnh sửa</button>
                <button disabled={state.isEdit} onClick={() => saveData()} type="button" className="mx-3 hms-btn-button btn btn-primary">Cập nhật</button>
            </div>
        </div>
    }
