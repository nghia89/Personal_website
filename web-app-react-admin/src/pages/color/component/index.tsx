    ...
    function renderHeader() {
        return <div className="pb-5 d-flex justify-content-between align-items-center">
            ...
            <div>
                ...
                {checkPermission(functionId.color, commandId.update) && <button onClick={() => saveData()} type="button" className="mx-3 hms-btn-button btn btn-primary">{props.id ? 'Cập nhật' : 'Lưu'}</button>}
            </div>
        </div>
    }
