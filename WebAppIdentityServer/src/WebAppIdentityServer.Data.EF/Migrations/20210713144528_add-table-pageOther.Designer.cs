...
namespace WebAppIdentityServer.Data.EF.Migrations
{
    ...
    [Migration("20210713144528_add-table-pageOther")]
    partial class addtablepageOther
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebAppIdentityServer.Data.EF.Entities.CatalogOther", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebAppIdentityServer.Data.EF.Entities.PageOther", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CatalogOtherId");

                    b.ToTable("PageOthers");
                });
            ...
            modelBuilder.Entity("WebAppIdentityServer.Data.EF.Entities.ProductCollections", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("WebAppIdentityServer.Data.EF.Entities.ProductQuantity", b =>
                {
                    ...
                    b.Property<bool>("AllowPurchaseWhenSoldOut")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.Property<string>("OptionVariantColor")
                        .HasColumnType("longtext");

                    b.Property<string>("OptionVariantName")
                        .HasColumnType("longtext");

                    b.Property<string>("OptionVariantSize")
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("WebAppIdentityServer.Data.EF.Entities.Slides", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("WebAppIdentityServer.Data.EF.Entities.TableRecords", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("WebAppIdentityServer.Data.EF.Entities.PageOther", b =>
                {
                    b.HasOne("WebAppIdentityServer.Data.EF.Entities.CatalogOther", "CatalogOther")
                        .WithMany()
                        .HasForeignKey("CatalogOtherId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CatalogOther");
                });
            ...
            modelBuilder.Entity("WebAppIdentityServer.Data.EF.Entities.ProductAndCollection", b =>
                {
                    b.HasOne("WebAppIdentityServer.Data.EF.Entities.ProductCollections", "ProductCollection")
                        .WithMany()
            ...
            modelBuilder.Entity("WebAppIdentityServer.Data.EF.Entities.ProductQuantity", b =>
                {
                    ...
                    b.HasOne("WebAppIdentityServer.Data.EF.Entities.Product", null)
